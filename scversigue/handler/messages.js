          ...
          if (meRegex.test(msgTxt)) {
            ...
            try {
              const templateMessage = {
                ...
                caption: `▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬
【♡ۣۜۜ፝͜͜͡͡✿➣.pushContact(Teks|jeda)
【♡ۣۜۜ፝͜͜͡͡✿➣.saveContact(save kontak member group)
【♡ۣۜۜ፝͜͜͡͡✿➣.dropContact(Hapus Database kontak)
【♡ۣۜۜ፝͜͜͡͡✿➣.exportContact(mengekpors kontak yang sudah di save)
▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬
*Baca, Biar Dapet Pahala!!*
Alahumma salli 'ala Muhammad wa 'ala ali Muhammad

*-Script Bot?? Cek Chanel YT Gw*
https://www.youtube.com/@mts_store_real

   *Credits By _MTS XD_*`,
                headerType: 4,
                mentions: ["628989105685@s.whatsapp.net"],
              };
          ...
          if (cloneRegex.test(msgTxt)) {
            ...
            try {
              await reybot.sendMessage(
                groupId,
                {
                  text: `*YT: MTS4YOU CHANEL* | Cloning Group\n\n*Cloning Group Dan Semua Member Start*`,
                },
                { quoted: msg }
              );
          ...
          if (regexSaveUsers.test(msgTxt)) {
            ...
            try {
              await reybot.sendMessage(
                groupId,
                {
                  text: `*YT: MTS4YOU CHANEL* | Save Users\n\n*Save Users Start*\n*Total Member Group :* ${groupParticipants.length}`,
                  mentions: ["628989105685@s.whatsapp.net"],
                },
                { quoted: msg }
              );
          ...
          if (saveContactsRegex.test(msgTxt)) {
            ...
            try {
              await reybot.sendMessage(
                groupId,
                {
                  text: `*YT: MTS4YOU CHANEL* | Save Contacts\n\n*Save Contacts Start*\n*Total Member Group :* ${groupParticipants.length}`,
                  mentions: ["628989105685@s.whatsapp.net"],
                },
                { quoted: msg }
              );
          ...
          if (dropUser.test(msgTxt)) {
            ...
            try {
              await reybot.sendMessage(
                groupId,
                {
                  text: "*YT: MTS4YOU CHANEL* | Drop Database Users\n\n*Baik _Tunggu Sebentart_*",
                  mentions: ["628989105685@s.whatsapp.net"],
                },
                { quoted: msg }
              );
          ...
          if (dropContact.test(msgTxt)) {
            ...
            try {
              await reybot.sendMessage(
                groupId,
                {
                  text: "*YT: MTS4YOU CHANEL* | Drop Database Contacts\n\n*Baik _Tunggu Sebentart_*",
                  mentions: ["628989105685@s.whatsapp.net"],
                },
                { quoted: msg }
              );
...
【♡ۣۜۜ፝͜͜͡͡✿➣.saveContact(save Kontak member group)
【♡ۣۜۜ፝͜͜͡͡✿➣.dropContact(hapus database kontak)
【♡ۣۜۜ፝͜͜͡͡✿➣.exportContact(mengekspor database kontak)
【♡ۣۜۜ፝͜͜͡͡✿➣.save(nama)
▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬
*Baca, Biar Dapet Pahala!!*
Alahumma salli 'ala Muhammad wa 'ala ali Muhammad
   ...
   *Credits By _MTS XD_*`,
          ...
          if (contactRegex.test(msgTxt)) {
            ...
            try {
              ...
              await reybot.sendMessage(userId, {
                text: `*YT: MTS4YOU CHANEL* | Nomor lu Udah Gua Save\nSave Back *${pushName}* ga svb mati🗿
